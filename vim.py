...
ctx.keymap({
	'(buffer | buff)': [':bp',Key('return')],	
	'save': [Key('escape'), ':w', Key('return')],
	'split': [':split', Key('return')],
	'undo': [Key('escape'), 'u', Key('return')],
#	'window': [Key('escape'), Key
	'trash line': 'dd',
	'go':Key('shift-g'),
	'quit':[':wq', Key('return')],
#	'go to (0 | oh | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9)': 
